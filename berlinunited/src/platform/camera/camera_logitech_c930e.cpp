#include "camera_logitech_c930e.h"
...
REGISTER_CAMERA("c930e", CameraLogitechC930e, "Logitech c930e USB webcam via v4l2");


/*------------------------------------------------------------------------------------------------*/

/** The following applies to the Logitech C930e camera with UVC interface.
 **
 ...
 **  Control Contrast                           (code: 980901, val: 128, min: 0, max: 255)
 **  Control Saturation                         (code: 980902, val: 128, min: 0, max: 255)
 ...
 **   50 Hz
 **   60 Hz
 **  Control White Balance Temperature          (code: 98091a, val: 4000, min: 2000, max: 7500)
 **  Control Sharpness                          (code: 98091b, val: 128, min: 0, max: 255)
 ...
 ** Control Exposure (Absolute)                 (code: 9a0902, val: 250, min: 3, max: 2047)
 ...
 ** Control Focus (absolute)                    (code: 9a090a, val: 0, min: 0, max: 255)
 ** Control Focus, Auto                         (code: 9a090c, val: 1, min: 0, max: 1)
 ** Control Zoom, Absolute                      (code: 9a090d, val: 100, min: 100, max: 400)
 **
 */

CameraLogitechC930e::CameraLogitechC930e() {
	...
	addSupportedSetting( CAMERA_ZOOM,               V4L2_CID_ZOOM_ABSOLUTE,              "Zoom",                           100,   100,    400 );
