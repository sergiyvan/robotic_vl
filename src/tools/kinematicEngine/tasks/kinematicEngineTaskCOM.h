...
public:
	...
	KinematicEngineTaskCOM(std::string name, MotorID baseNode, MotorID effectorNode, MotorID referenceCoordinate, const KinematicTree &tree, SubDimension subDimension = DIMENSIONS_XYZ);
...
private:
	...
	KinematicEngineTaskCOM::SubDimension m_subDimension;
	uint8_t m_dimCnt;
};
