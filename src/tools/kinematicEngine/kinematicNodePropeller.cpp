...
KinematicNodePropeller::KinematicNodePropeller(MotorID id,
	...
	: KinematicNodeWheel(id, parent, name, maxForce, maxSpeed, translationX, translationY, translationZ, alphaX, alphaY, alphaZ)
	, m_rotationJoint(nullptr)
	, m_motor(nullptr)
...
dBodyID KinematicNodePropeller::attachToODE(PhysicsEnvironment *environment, dSpaceID visualSpaceID, dSpaceID collisionSpaceID, arma::mat44 parentsCoordinateFrame)
{
	...
	m_motor = new ODEPropellerMotor(id, m_rotationJoint, environment, this, m_maxForce, m_maxSpeed, m_speedToForceFactor);
