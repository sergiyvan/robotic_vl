	...
	, sizeZ(sizeZ)
{
	...
	vertices[0] = arma::colvec({ -sizeX.value()/2, -sizeY.value()/2, +sizeZ.value()/2, 1. });
	vertices[1] = arma::colvec({ +sizeX.value()/2, -sizeY.value()/2, +sizeZ.value()/2, 1. });
	vertices[2] = arma::colvec({ +sizeX.value()/2, -sizeY.value()/2, -sizeZ.value()/2, 1. });
	vertices[3] = arma::colvec({ -sizeX.value()/2, -sizeY.value()/2, -sizeZ.value()/2, 1. });
	vertices[4] = arma::colvec({ -sizeX.value()/2, +sizeY.value()/2, +sizeZ.value()/2, 1. });
	vertices[5] = arma::colvec({ +sizeX.value()/2, +sizeY.value()/2, +sizeZ.value()/2, 1. });
	vertices[6] = arma::colvec({ +sizeX.value()/2, +sizeY.value()/2, -sizeZ.value()/2, 1. });
	vertices[7] = arma::colvec({ -sizeX.value()/2, +sizeY.value()/2, -sizeZ.value()/2, 1. });
