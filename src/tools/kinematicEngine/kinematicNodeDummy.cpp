...
KinematicNodeDummy::KinematicNodeDummy(MotorID id,
										...
										Degree alphaY,
										Degree alphaZ)
		: KinematicNode(id, parent, name, 0., 0., 0., translationX, translationY, translationZ, alphaX, alphaY, alphaZ)
{
}
...
arma::colvec3 KinematicNodeDummy::getPartialDerivativeOfLocationToEffector(arma::colvec3 effector) const
{
	return arma::zeros(3);
}

arma::colvec3 KinematicNodeDummy::getPartialDerivativeOfOrientationToEffector(arma::colvec3 effector) const
{
	return arma::zeros(3);
}
...
dMass KinematicNodeDummy::getODEMassToAttachToParent(arma::mat44 coordinateFrame)
{
	dMass compositeMass;
