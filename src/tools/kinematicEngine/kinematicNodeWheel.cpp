...
KinematicNodeWheel::KinematicNodeWheel()
...
KinematicNodeWheel::KinematicNodeWheel(MotorID id,
...
dBodyID KinematicNodeWheel::attachToODE(PhysicsEnvironment *environment, dSpaceID visualSpaceID, dSpaceID collisionSpaceID, arma::mat44 parentsCoordinateFrame)
{
	...
	m_motor = new ODEWheelMotor(id, m_rotationJoint, environment, this, m_maxForce, m_maxSpeed);
