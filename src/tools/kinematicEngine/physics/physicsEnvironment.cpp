...
public:
	...
	void setKinematicModel(PhysicsEnvironment *environment, KinematicTree *tree, arma::mat44 coordinateFrame, KinematicNode *node)
	{
		node->attachToODE(environment, m_visualSpace.id(), m_collisionSpace.id(), coordinateFrame);
	}
